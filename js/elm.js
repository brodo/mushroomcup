...
Elm.MushroomCup.make = function (_elm) {
   ...
   var Games = function (a) {
      return {ctor: "Games",_0: a};
   };
   var PlayerList = function (a) {
      return {ctor: "PlayerList"
             ,_0: a};
   };
   var view = F2(function (address,
   model) {
   ...
   var modelToGameContext = function (model) {
      return {_: {}
             ,playerList: model.playerList.players};
   };
   var update = F2(function (action,
   model) {
      return function () {
         ...
         {case "Games":
            return function () {
                 var context = modelToGameContext(model);
            ...
            return _U.replace([["playerList"
                               ,A2($PlayerList.update,
                               action._0,
                               model.playerList)]],
              model);}
         _U.badCase($moduleName,
         "between lines 47 and 60");
      }();
   });
   var initialModel = {_: {}
   ...
   _elm.MushroomCup.values = {_op: _op
                             ...
                             ,initialModel: initialModel
                             ,model: model
                             ,modelToGameContext: modelToGameContext
                             ,NoOp: NoOp
...
Elm.PlayerList.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm);
   var focusSelector = function (_v0) {
      return function () {
         return "#playername";
      }();
   };
   ...
   model) {
      return function () {
         switch (action.ctor)
         {case "AddPlayer":
            return model.isValidPlayerName ? _U.replace([["players"
                                                         ,A2($List._op["::"],
                                                         model.newPlayer,
                                                         model.players)]
                                                        ,["newPlayer",""]
   ...
   model) {
      return function () {
         ...
         _L.fromArray([A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("input-field ")]),
         _L.fromArray([A2($Html.i,
                      _L.fromArray([$Html$Attributes.$class("material-icons prefix")]),
                      _L.fromArray([$Html.text("account_circle")]))
                      ,A2($Html.input,
                      _L.fromArray([$Html$Attributes.id("playername")
                                   ...
                                   setNewPlayerName)
                                   ,A2($Html$Events.onKeyPress,
                                   address,
                                   addPlayer)
                                   ,$Html$Attributes.value(model.newPlayer)]),
                      _L.fromArray([]))
                      ,A2($Html.label,
                      _L.fromArray([$Html$Attributes.$for("playername")]),
   ...
   model) {
      return function () {
         ...
         _L.fromArray([A2($Html.h5,
         _L.fromArray([]),
         _L.fromArray([$Html.text("Players")]))]));
         ...
         listHeader,
         list),
         _L.fromArray([A2(addPlayerView,
         address,
         model)]));
         return $Html.ul(_L.fromArray([$Html$Attributes.$class("collection with-header")]))(listWithHeaderAndFooter);
      }();
   });
   var initialModel = {_: {}
