...
Elm.GameList.make = function (_elm) {
   ...
   var playerRankListItem = F2(function (index,name) {
      ...
      _U.list([A2($Html.span,
              ...
              _U.list([$Html.text($Basics.toString(rank))]))
              ,A2($Html.span,
              _U.list([$Html$Attributes.$class("oneRemLeft")]),
   ...
   var PlacementsReady = function (a) {
      return {ctor: "PlacementsReady",_0: a};
   };
   var placesReadyButton = F2(function (address,game) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.a,
      _U.list([$Html$Attributes.$class("waves-effect waves-light btn")
              ,A2($Html$Events.onClick,address,PlacementsReady(game.id))]),
   ...
   var finishedPlayerRankListItem = F4(function (address,
   playerCount,
   index,
   name) {
      var downButton = A2($Html.a,
      _U.list([$Html$Attributes.$class("waves-effect waves-light btn oneRemLeft")
              ,A2($Html$Events.onClick,address,MoveDown(name))]),
      _U.list([$Html.text("↓")]));
      var upButton = A2($Html.a,
      _U.list([$Html$Attributes.$class("waves-effect waves-light btn fourRemLeft")
              ,A2($Html$Events.onClick,address,MoveUp(name))]),
      _U.list([$Html.text("↑")]));
      var isFirst = _U.eq(index,0);
      var rank = index + 1;
      var isLast = _U.eq(rank,playerCount);
      var buttons = isLast ? _U.list([upButton]) : isFirst ? _U.list([downButton]) : _U.list([upButton
                                                                                             ,downButton]);
      return A2($Html.li,
      _U.list([$Html$Attributes.$class("collection-item")]),
      _U.list([A2($Html.span,
   ...
   var finishedGameCard = F2(function (address,game) {
      var sortedPlaces = A2($List.sortBy,
      function (_p0) {
         var _p1 = _p0;
         return _p1._0;
      },
      ...
      sortedPlaces);
      var playerCount = $List.length(game.players);
      var playerRankListItemWithCount = A2(finishedPlayerRankListItem,
      address,
      playerCount);
      return A2($Html.div,
      ...
      _U.list([A2($Html.span,
              ...
              A2($List.indexedMap,playerRankListItemWithCount,players))
              ,A2(placesReadyButton,address,game)]))]));
   });
   var resultsGameCard = F2(function (address,game) {
      var sortedPlaces = A2($List.sortBy,
      function (_p4) {
         var _p5 = _p4;
         return _p5._0;
      ...
      _U.list([A2($Html.span,
              ...
              ,A2($Html.ul,
              _U.list([$Html$Attributes.$class("collection")]),
              A2($List.indexedMap,playerRankListItem,players))]))]));
   });
   ...
   var view = F2(function (address,game) {
      ...
      {case "New": return A2(newGameCard,address,game);
         ...
         default: return A2(resultsGameCard,address,game);}
   });
   ...
   var gameForPlayer = F2(function (playerName,model) {
      var game = $List.head(A2($List.filter,
      function (g) {
         return A2($List.member,playerName,g.players);
      },
      model));
      return A2($Maybe.withDefault,A2(newGame,0,_U.list([])),game);
   });
   var placeUpdater = F3(function (name,model,updater) {
      var game = A2(gameForPlayer,name,model);
      var _p9 = A2($Maybe.withDefault,
      {ctor: "_Tuple2",_0: 0,_1: ""},
      A2($List$Extra.find,
      function (_p10) {
         var _p11 = _p10;
         return _U.eq(_p11._1,name);
      },
      game.places));
      var place = _p9._0;
      var newGame = _U.update(game,
      {places: A2($List.map,updater(place),game.places)});
      return A2($List.map,
      function (g) {
         return _U.eq(g.id,game.id) ? newGame : g;
      },
      model);
   });
   var update = F2(function (action,model) {
      ...
      {case "StartGame": var updater = function (game) {
              return _U.eq(game.id,_p12._0) ? _U.update(game,
              {state: Running
              ,places: A2($List.indexedMap,
              F2(function (v0,v1) {
                 return {ctor: "_Tuple2",_0: v0,_1: v1};
              }),
              game.players)}) : game;
         ...
         case "StopGame": var updater = function (game) {
           ...
           return A2($List.map,updater,model);
         case "PlacementsReady": var updater = function (game) {
              return _U.eq(game.id,_p12._0) ? _U.update(game,
              {state: ResultsAdded}) : game;
           };
           return A2($List.map,updater,model);
         case "MoveUp": var _p17 = _p12._0;
           var updatePlaces = F2(function (place,_p13) {
              var _p14 = _p13;
              var _p16 = _p14._1;
              var _p15 = _p14._0;
              return _U.eq(_p15,place - 1) ? {ctor: "_Tuple2"
                                             ,_0: _p15 + 1
                                             ,_1: _p16} : _U.eq(_p16,_p17) ? {ctor: "_Tuple2"
                                                                             ,_0: _p15 - 1
                                                                             ,_1: _p16} : {ctor: "_Tuple2",_0: _p15,_1: _p16};
           });
           return A3(placeUpdater,_p17,model,updatePlaces);
         default: var _p22 = _p12._0;
           var updatePlaces = F2(function (place,_p18) {
              var _p19 = _p18;
              var _p21 = _p19._1;
              var _p20 = _p19._0;
              return _U.eq(_p20,place + 1) ? {ctor: "_Tuple2"
                                             ,_0: _p20 - 1
                                             ,_1: _p21} : _U.eq(_p21,_p22) ? {ctor: "_Tuple2"
                                                                             ,_0: _p20 + 1
                                                                             ,_1: _p21} : {ctor: "_Tuple2",_0: _p20,_1: _p21};
           });
           return A3(placeUpdater,_p22,model,updatePlaces);}
   });
   var makeGames = F2(function (players,seed) {
      var randomList = A2($ListUtils.shuffle,players,seed);
...
Elm.PlayerList.make = function (_elm) {
   ...
   if (_elm.PlayerList.values) return _elm.PlayerList.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var focusSelector = function (_p0) {    return "#playername";};
   var focusFilter = function (action) {
      var _p1 = action;
      if (_p1.ctor === "AddPlayer") {
            return true;
         } else {
            return false;
         }
   ...
   var updateGlobal = F2(function (action,model) {
      var _p2 = action;
      if (_p2.ctor === "StartTournamentGlobal") {
            return _U.update(model,{tournamentStarted: false});
         } else {
            return model;
         }
   });
      ...
      {case "NoOp": return {ctor: "_Tuple2"
         ...
         return model.isValidPlayerName ? {ctor: "_Tuple2"
                                          ...
                                          ,_1: $Globals.AddPlayerGlobal(model.newPlayer)} : {ctor: "_Tuple2"
                                                                                            ,_0: model
                                                                                            ,_1: $Globals.NoOpGlobal};
         case "RemovePlayer": var _p4 = _p3._0;
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  {players: A2($List.filter,
                  function (str) {
                     return !_U.eq(str,_p4);
                  },
                  model.players)})
                  ,_1: $Globals.RemovePlayerGlobal(_p4)};
         case "SetNewPlayerName": var _p5 = _p3._0;
           var trimmedName = $String.trim(_p5);
           var isValid = !_U.eq(trimmedName,
           "") && $Basics.not(A2($List.member,trimmedName,model.players));
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,
                  {newPlayer: _p5
                  ...
                  ,_1: $Globals.NoOpGlobal};
         default: return {ctor: "_Tuple2"
                         ,_0: A2(updateGlobal,_p3._0,model)
                         ,_1: $Globals.NoOpGlobal};}
   });
   ...
   var SetNewPlayerName = function (a) {
      return {ctor: "SetNewPlayerName",_0: a};
   };
   var AddPlayer = {ctor: "AddPlayer"};
   var NoOp = {ctor: "NoOp"};
   var addPlayerView = F2(function (address,model) {
      ...
      var addPlayer = function (code) {
         return _U.eq(code,13) ? AddPlayer : NoOp;
      };
      var setNewPlayerName = function (str) {
         return A2($Signal.message,address,SetNewPlayerName(str));
      };
      return A2($Html.li,
      _U.list([$Html$Attributes.$class("collection-item")]),
      _U.list([A2($Html.div,
      ...
      _U.list([A2($Html.i,
              _U.list([$Html$Attributes.$class("material-icons prefix")]),
              _U.list([$Html.text("account_circle")]))
              ,A2($Html.input,
              _U.list([$Html$Attributes.id("playername")
                      ,$Html$Attributes.type$("text")
                      ,$Html$Attributes.$class(textFieldClass)
                      ,A3($Html$Events.on,
                      "input",
                      $Html$Events.targetValue,
                      setNewPlayerName)
                      ,A2($Html$Events.onKeyPress,address,addPlayer)
                      ,$Html$Attributes.value(model.newPlayer)]),
              _U.list([]))
              ,A2($Html.label,
              _U.list([$Html$Attributes.$for("playername")]),
              _U.list([$Html.text("Player Name")]))]))]));
   });
   var view = F2(function (address,model) {
      var listHeader = A2($Html.li,
      _U.list([$Html$Attributes.$class("collection-header")]),
      _U.list([A2($Html.h5,
      _U.list([]),
      ...
      var listItem = F2(function (index,str) {
         ...
         _U.list([$Html.text(str)
                 ...
                 _U.list([$Html$Attributes.$class("secondary-content")
                         ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                          ,_0: "cursor"
                                                          ,_1: "pointer"}]))
                         ,A2($Html$Events.onClick,address,RemovePlayer(str))]),
                 _U.list([A2($Html.i,
      ...
      address,
      model)])) : A2($List._op["::"],listHeader,list);
      return A2($Html.ul,
      _U.list([$Html$Attributes.$class("collection with-header")]),
      listWithHeaderAndFooter);
   });
   var initialModel = {newPlayer: ""
                      ,players: _U.list([])
                      ,isValidPlayerName: false
                      ,showErrorInTextField: false
   ...
   return _elm.PlayerList.values = {_op: _op
...
Elm.MushroomCup.make = function (_elm) {
   ...
   if (_elm.MushroomCup.values) return _elm.MushroomCup.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Globals = Elm.Globals.make(_elm),
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return model;
         case "PlayerList": var _p1 = A2($PlayerList.update,
           _p0._0,
           model.playerList);
           var players = _p1._0;
         ...
         case "GameList": var _p2 = A2($Tournament.update,
           ...
           var newModel = A2(updateGlobal,globalAction,model);
           return _U.update(newModel,{games: games});
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([header
              ...
              _U.list([A2($Html.div,
                      ...
                      _U.list([A2($PlayerList.view,
                      A2($Signal.forwardTo,address,PlayerList),
                      model.playerList)]))
                      ,A2($Html.div,
   ...
   function () {
      var filter = function (action) {
         var _p3 = action;
         if (_p3.ctor === "PlayerList") {
               return $PlayerList.focusFilter(_p3._0);
            } else {
               return false;
            }
      };
      ...
      var selector = function (action) {
         var _p4 = action;
         if (_p4.ctor === "PlayerList") {
               return $PlayerList.focusSelector(_p4._0);
            } else {
               return "";
            }
      };
      return A2($Signal.map,selector,filteredActions);
   }());
   var ticker = A2($Signal.map,
   function (_p5) {
      return Global($Globals.SetTimeGlobal(_p5));
   },
   ...
   var Model = F2(function (a,b) {
      return {playerList: a,games: b};
   });
   return _elm.MushroomCup.values = {_op: _op
                                    ,Model: Model
                                    ,initialModel: initialModel
                                    ,ticker: ticker
